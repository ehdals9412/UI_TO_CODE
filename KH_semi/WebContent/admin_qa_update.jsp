...
<body>
	...
	<div class="container">
		<form id="frm" action="SemiProjectServlet.do" method="post">
			<input type="hidden" name="command" value="admin_qaupdate" /> <input
				type="hidden" name="qa_id" value="${dto.qa_id }" />
			...
			<div class="subject_form">
				...
				<div class="form-group">
					<input type="text" name="title" value="${dto.qa_title }" />
				</div>
			</div>
			...
			<div class="buttons">
				...
				<button type="button" class="btn btn-default"
					onclick="location.href='SemiProjectServlet.do?command=admin_qaview&qa_id=${dto.qa_id}'">취소</button>
			</div>
		</form>
