...
<body>
	...
	<div class="container">
		...
		<input type="hidden" name="command" value="qaupdate"/>
		<input type="hidden" name="qa_id" value="${dto.qa_id }"/>
			...
			<button type="button" class="btn btn-default" onclick="location.href='SemiProjectServlet.do?command=qadetail&qa_id=${dto.qa_id}'">취소</button>
		</div>
		</form>
